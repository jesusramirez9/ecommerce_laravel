    ...
    <div class="min-h-screen bg-white">
        ...
        <div class="bg-pago">
            <div class="container py-4 flex justify-between items-center">
                <div class=" metodopago_rps verdegreen text-xl md:text-2xl lg:text-3xl font-bold">
                    Métodos de pago
                </div>
                <div>
                    <img src="{{ asset('images/inicio/seccion6/mastercard.png') }}" alt="">
                </div>
                <div>
                    <img src="{{ asset('images/inicio/seccion6/visa.png') }}" alt="">
                </div>
                <div>
                    <img src="{{ asset('images/inicio/seccion6/diners.png') }}" alt="">
                </div>
                <div>
                    <img src="{{ asset('images/inicio/seccion6/american.png') }}" alt="">
                </div>
            </div>
        </div>
        <footer class="bg-footer ">
            <div class="container ">
                <div
                    ...
                    <div>
                        <p class="mb-3 font-bold">SERVICIO AL CLIENTE</p>
                    ...
                    <div>
                        <p class="mb-3 font-bold">MI CUENTA</p>
                        <ul class="font-normal">
                    ...
                    <div>
                        <p class="mb-3 font-bold">NOSOTROS</p>
                        <ul class="font-normal">
                    ...
                    <div>
                        <p class="mb-3 font-bold">REDES SOCIALES</p>
                        ...
                        <a href="{{ route('reclamacion') }}">
                            <div class="flex justify-center lg:justify-start  mt-5">
                                ...
                                <img src="{{ asset('images/inicio/seccion6/libro.png') }}" alt="">
                                <p class="ml-4 font-normal text-left">
        ...
        <div class="bg-pago py-2 posfixd foot_sharp_usr">
