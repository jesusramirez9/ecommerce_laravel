<div>
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <x-button-enlace href="{{route('admin.products.create')}}" class="bg-red-300 ml-auto">
                Agregar producto
            </x-button-enlace>
        </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                       ...
                                       @else
                                       <img class="h-10 w-10 rounded-full object-cover"
                                       src="https://images.pexels.com/photos/5082560/pexels-photo-5082560.jpeg?cs=srgb&dl=pexels-cottonbro-5082560.jpg&fm=jpg" alt="">
                                       @endif
                                    </div>
                                    <div class="ml-4">
