<div>
    <header class="head_web sticky top-0" style="z-index:900" x-data="dropdown()">
        <div class="container flex items-center h-16 justify-between md:justify-start">
            ...
            <a class="mr-6" href="/">
                ...
                <img src="{{ asset('images/inicio/seccion1/Logo.png') }}" class="block h-9 w-auto" alt="">
            </a>
            <ul class="flex linkdiv link_vrdweb">
                <li class="h-opcs-li list-group-item nav-item-2">
                    <a href="{{ route('home') }}"
                        class="blog_nzv {{ request()->is('/') ? 'active' : '' }}">Inicio</a>
                </li>
                ...
                <li class="h-opcs-li3 list-group-item nav-item-2">
                    <a href="{{ route('bloga') }}"
                        class=" blog_nzv {{ request()->is('blog') ? 'active' : '' }}">Blog</a>
    ...
    <div class="head_movilx">
        ...
        <div class="flex justify-center">
            <ul class="mt-4 link_vrd flex">
                ...
                <li class="h-opcs-li list-group-item nav-item-2"> <a href="{{ route('home') }}"
                        class="blog_nzv {{ request()->is('/') ? 'active' : '' }}">Inicio</a></li>
                <li class="h-opcs-li2 list-group-item nav-item-2"> <a href="/categories/moda"
                        class="blog_nzv space_link  {{ request()->is('categories/moda') ? 'active' : '' }}">Catalogo</a>
                </li>
                <li class="h-opcs-li3 list-group-item nav-item-2"><a href="{{ route('bloga') }}"
